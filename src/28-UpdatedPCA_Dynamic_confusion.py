...
for var in variance:
    ...
    f = open("../PCADynamicStatic/pca/PCA2components-Train-family_variance-"+var+".pickle","rb")
    ...
    f = open("../PCADynamicStatic/pca/PCA2components-Test-family_variance-"+var+".pickle","rb")
    data,families = pickle.load(f)
    ...
    f = open("../PCADynamicStatic/pca/PCA2components-Upx-family_variance-"+var+".pickle","rb")
    data,families = pickle.load(f)
    ...
    f = open("../PCADynamicStatic/pca/PCA2components-UpxUnpacked-family_variance-"+var+".pickle","rb")
    data,families = pickle.load(f)
    ...
    plt.savefig("../Heatmaps/HM-DynamicPCATest_2p.pdf")
    plt.clf()
    plt.close()
    ...
    sns.set(font_scale=1.2)
    ax = sns.heatmap(df,annot=True,cmap="gray_r",cbar=False,linewidths=0.1, linecolor='black')
    plt.savefig("../Heatmaps/HM-DynamicPCAUnpacked_2p.pdf")
    plt.clf()
    plt.close()
    ...
    sns.set(font_scale=1.2)
    ax = sns.heatmap(df,annot=True,cmap="gray_r",cbar=False,linewidths=0.1, linecolor='black')
    plt.savefig("../Heatmaps/HM-DynamicPCAPacked_2p.pdf")
    plt.clf()
    plt.close()
