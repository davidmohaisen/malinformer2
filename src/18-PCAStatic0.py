...
for var in variance:
    ...
    f = open("../priorWorks/staticPCA/PCA2components-Train-family_variance-"+var+".pickle","rb")
    data = pickle.load(f)

    f = open("../priorWorks/staticPCA/Train_Family.pickle","rb")
    ...
    f = open("../priorWorks/staticPCA/PCA2components-Test-family_variance-"+var+".pickle","rb")
    data = pickle.load(f)
    x_test = np.asarray(data)

    f = open("../priorWorks/staticPCA/Test_Family.pickle","rb")
    families = pickle.load(f)
