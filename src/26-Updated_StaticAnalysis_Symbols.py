...
#
# f = open("../priorWorks/updatedData/pickles/SymbolsF","wb")
...
# f = open("../priorWorks/updatedData/pickles/SymbolsTrainDataP1", "wb")
# pickle.dump([x_train[:int(len(x_train)/2)],y_train[:int(len(x_train)/2)]],f)
# f = open("../priorWorks/updatedData/pickles/SymbolsTrainDataP2", "wb")
# pickle.dump([x_train[int(len(x_train)/2):],y_train[int(len(x_train)/2):]],f)
#
# print(x_train.shape)
# print(y_train.shape)
...
# f = open("../priorWorks/updatedData/pickles/SymbolsTestData", "wb")
...
#             f = open(pathTest+FileToDealWith+".pickle","rb")
#             x = pickle.load(f)
#             x_unpacked.append(([0]*len(trainFunctionNames)))
#             for x_part in x.keys():
#                 try:
#                     x_unpacked[-1][int(dicLocations[x_part])] = x[x_part][1]
#                 except KeyError:
#                     pass
...
# f = open("../priorWorks/updatedData/pickles/SymbolsUnpackedData", "wb")
...
#
#
# pathPacked = "../priorWorks/updatedData/upxPacked/symbols/"
# x_packed = []
# y_packed = []
# for fo_index in range(len(FO)):
#     for file_index in range(len(labels_packed[FO[fo_index]])):
...
#             x = pickle.load(f)
#             x_packed.append(([0]*len(trainFunctionNames)))
#             for x_part in x.keys():
#                 try:
#                     x_packed[-1][int(dicLocations[x_part])] = x[x_part][1]
#                 except KeyError:
#                     pass
...
# f = open("../priorWorks/updatedData/pickles/SymbolsPackedData", "wb")
...
f = open("../priorWorks/updatedData/pickles/SymbolsTrainDataP1","rb")
x_train_1, y_train_1 = pickle.load(f)
f = open("../priorWorks/updatedData/pickles/SymbolsTrainDataP2","rb")
x_train_2, y_train_2 = pickle.load(f)
x_train = np.concatenate((x_train_1,x_train_2))
y_train = np.concatenate((y_train_1,y_train_2))
f = open("../priorWorks/updatedData/pickles/SymbolsTestData","rb")
x_test, y_test = pickle.load(f)
f = open("../priorWorks/updatedData/pickles/SymbolsUnpackedData","rb")
x_unpacked, y_unpacked = pickle.load(f)
f = open("../priorWorks/updatedData/pickles/SymbolsPackedData","rb")
...
# print(f1_score(y_true, y_pred, average='weighted'))
#
# f = open("../priorWorks/updatedData/models/SymbolsBaselineLR","wb")
# pickle.dump(clf,f)
#
#
# print("==========================================================================")
...
# print(f1_score(y_true, y_pred, average='weighted'))
#
# f = open("../priorWorks/updatedData/models/SymbolsBaselineRF","wb")
# pickle.dump(clf,f)
#
# print("==========================================================================")
# print("KNN")
...
#     print(f1_score(y_true, y_pred, average='weighted'))
#
#     f = open("../priorWorks/updatedData/models/SymbolsBaselineKNN"+str(neighbor),"wb")
#     pickle.dump(clf,f)
#
...
# print(f1_score(y_true, y_pred, average='weighted'))
#
# f = open("../priorWorks/updatedData/models/SymbolsBaselineSVM","wb")
# pickle.dump(clf,f)
#
#
...
# with open("../priorWorks/updatedData/models/SymbolsBaselineDNN.json", "w") as json_file:
#     json_file.write(model_json)
# # serialize weights to HDF5
# model.save_weights("../priorWorks/updatedData/models/SymbolsBaselineDNN.h5")
...
model_json = model.to_json()
with open("../priorWorks/updatedData/models/SymbolsBaselineCNN.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("../priorWorks/updatedData/models/SymbolsBaselineCNN.h5")
print("Saved model to disk")
