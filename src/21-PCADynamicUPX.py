...
for var in variance:
    ...
    f = open("../UPX/pca/PCA2components-Train-family_variance-"+var+".pickle","rb")
    data = pickle.load(f)

    f = open("../UPX/pca/Train_Family.pickle","rb")
    ...
    f = open("../UPX/pca/PCA2components-Test-family_variance-"+var+".pickle","rb")
    data = pickle.load(f)
    x_test = np.asarray(data)

    f = open("../UPX/pca/Test_Family.pickle","rb")
    families = pickle.load(f)
