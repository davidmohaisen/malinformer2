...
f = open("../../data/priorStudy/TrainData/Disassembly_trainData-FamOrder-Edited.pickle","rb")
...
f = open("../../data/priorStudy/TestData/Disassembly_testData-FamOrder-Edited.pickle","rb")
data,families = pickle.load(f)
data = data.todense()

x_test = np.asarray(data)

f = open("../../data/priorStudy/testFamily_MalwareList.pickle","rb")
...
f = open("../../data/priorStudy/PCADisassymbly.pickle", "wb")
